...
//create query
	$query="INSERT INTO product(product_name,product_desc,cat_id,product_image,customer_id)VALUES('$product_name','$product_desc','$cat_id','$pro_images',$customer_id)";
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong class="card-title">Your Pat Table</strong>
						</div>
						<div class="card-body">
							<table class="table table-striped">
								...
								<tbody>
									...
									while ($row = mysqli_fetch_assoc($result)) {
										...
										echo "<td><img style='height: 150px; width: 150px; max-width: none;' src='admin/uplode/{$row['product_image']}'></td>";
