...
//create query
	$query="INSERT INTO product(product_name,product_desc,product_image,cat_id,customer_id,mobile)VALUES('$product_name','$product_desc','$pro_images','$cat_id',$customer_id,'$mobile')";
						...
						<div class="card-body">
							...
							<form action="" method="post" novalidate="novalidate" enctype="multipart/form-data" >
								<div class="form-group">
									...
									<input id="cc-pament" required=""  name="pet_name" type="email" class="form-control" aria-required="true" aria-invalid="false" >
								</div>
								<div class="form-group">
									<label for="cc-payment"  class="control-label mb-1">Pat Decription</label>
									<input id="cc-pament" required="" name="pet_desc" type="text" class="form-control" aria-required="true" aria-invalid="false" >
								</div>
								...
								<div>
									...
									<span id="payment-button-amount">Add Pet</span>
